...
export const sitePages = {
  grocery: {
    page_title: 'Grocery - ServiceBack',
  ...
  clothing: {
    page_title: 'Clothing - ServiceBack',
  ...
  furniture: {
    page_title: 'Furniture - ServiceBack',
  ...
  medicine: {
    page_title: 'Medicine - ServiceBack',
