...
We are using hygen to generate scaffolding for common pieces of the application

### Getting Setup

1. Run `npm install -g hygen`
2. Templates are available in `_templates` folder
